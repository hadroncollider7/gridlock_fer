"""
Uses the FER2013 dataset to validate the emotion prediction model.
"""
...
img_filenames_angry = os.listdir('D:/Projects/Datasets/fer_2013/test/angry')
...
img_filenames_disgust = os.listdir('D:/Projects/Datasets/fer_2013/test/disgust')
...
img_filenames_fear = os.listdir('D:/Projects/Datasets/fer_2013/test/fear')
...
img_filenames_happy = os.listdir('D:/Projects/Datasets/fer_2013/test/happy')
...
img_filenames_neutral = os.listdir('D:/Projects/Datasets/fer_2013/test/neutral')
...
img_filenames_sad = os.listdir('D:/Projects/Datasets/fer_2013/test/sad')
for i in range(len(img_filenames_sad)):
    img_filenames_sad[i] = "sad/"+img_filenames_sad[i]
groundLabels_sad = [2] * len(img_filenames_sad)

img_filenames_surprise = os.listdir('D:/Projects/Datasets/fer_2013/test/surprise')
...
img_filenames = img_filenames_angry+img_filenames_disgust+img_filenames_fear+img_filenames_happy+img_filenames_neutral+img_filenames_sad+img_filenames_surprise
groundLabels = groundLabels_angry+groundLabels_disgust+groundLabels_fear+groundLabels_happy+groundLabels_neutral+groundLabels_sad+groundLabels_surprise
...
if generate_predictions_list == True:
        ...
        save_list(predictions, 'validation/fer2013_testSet_predictions.pkl')
        print("predictions object type: ", type(predictions))
        print("predictions element type: ", type(predictions[0]))
        print("predictions length", len(predictions))
else:
    predictions = read_list('validation/fer2013_testSet_predictions.pkl')
    print("predictions object type: ", type(predictions))
    print("predictions element type: ", type(predictions[0]))
    print("predictions length", len(predictions))
